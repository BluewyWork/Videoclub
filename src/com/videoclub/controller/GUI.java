/**
 * The `GUI` class represents the graphical user interface of the videoclub application.
 * It initializes the necessary controllers and sets up the main window.
 */
